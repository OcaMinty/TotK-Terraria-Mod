...
{
    public class GloomSwordSpear : ModItem
    {
        public override void SetStaticDefaults()
        {
            // Tooltip.SetDefault("A Gloom Spear fused with a Gloom Sword.");
        ...
        public override void SetDefaults()
        {
            ...
            Item.shoot = ModContent.ProjectileType<GloomSwordSpearProjectile>(); // The projectile that is fired from this weapon
