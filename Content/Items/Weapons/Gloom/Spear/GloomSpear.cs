...
{
    public class GloomSpear : ModItem
    {
        public override void SetStaticDefaults()
        {
            // Tooltip.SetDefault("'Amalgamation Stick'?\nSlowly eats away at your Max Health. Be warned.");
        ...
        public override void SetDefaults()
        {
            ...
            Item.shoot = ModContent.ProjectileType<GloomSpearProjectile>(); // The projectile that is fired from this weapon
        ...
        {
            CreateRecipe()
               .AddIngredient(ModContent.ItemType<Zonaite>(), 900)
