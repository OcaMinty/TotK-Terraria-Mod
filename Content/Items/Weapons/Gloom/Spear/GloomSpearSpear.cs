...
{
    public class GloomSpearSpear : ModItem
    {
        public override void SetStaticDefaults()
        {
            // Tooltip.SetDefault("A Gloom Spear fused with a Gloom Spear.");
        ...
        public override void SetDefaults()
        {
            ...
            Item.shoot = ModContent.ProjectileType<GloomSpearSpearProjectile>(); // The projectile that is fired from this weapon
        ...
        {
            CreateRecipe()
               .AddIngredient(ModContent.ItemType<GloomSpear>(), 2)
               .Register();
        }
    }
}