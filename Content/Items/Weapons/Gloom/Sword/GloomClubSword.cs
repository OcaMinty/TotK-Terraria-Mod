...
{
    public class GloomClubSword : ModItem
    {
        public override void SetStaticDefaults()
        {
            // DisplayName.SetDefault("Gloom Club Sword");
            // Tooltip.SetDefault("A Gloom Sword fused with a Gloom Club."); // The (English) text shown below your weapon's name.
        ...
        public override void SetDefaults()
        {
            ...
            Item.damage = 480; // The damage your item deals.
