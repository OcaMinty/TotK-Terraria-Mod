...
namespace totk.Content.Items.Weapons.Gloom.Sword
{
    public class GloomSword : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.value = Item.buyPrice(silver: 40); // The value of the weapon in copper coins.
        ...
        {
            CreateRecipe()
                .AddIngredient(ModContent.ItemType<Zonaite>(), 800)
