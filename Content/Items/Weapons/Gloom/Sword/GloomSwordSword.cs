...
{
    public class GloomSwordSword : ModItem
    {
        public override void SetStaticDefaults()
        {
            // DisplayName.SetDefault("Gloom Sword Sword");
            // Tooltip.SetDefault("A Gloom Sword fused with a Gloom Sword."); // The (English) text shown below your weapon's name.
        ...
        {
            CreateRecipe()
                .AddIngredient(ModContent.ItemType<GloomSword>(), 2)
                .Register();
        }
    }
}