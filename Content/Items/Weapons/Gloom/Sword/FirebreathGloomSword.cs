...
namespace totk.Content.Items.Weapons.Gloom.Sword
{
    public class FirebreathGloomSword : ModItem
    {
        public override void SetStaticDefaults()
        {
            // DisplayName.SetDefault("Fire-breath Gloom Sword");
            // Tooltip.SetDefault("A Gloom Sword fused with a Fire-breath Lizalfos Horn."); // The (English) text shown below your weapon's name.
        ...
        public override void SetDefaults()
        {
            ...
            Item.damage = 204; // The damage your item deals.
