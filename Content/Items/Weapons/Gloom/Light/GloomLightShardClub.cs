...
{
    public class GloomLightShardClub : ModItem
    {
        public override void SetStaticDefaults()
        {
            // DisplayName.SetDefault("Gloom Light Shard Club");
            // Tooltip.SetDefault("A Gloom Club fused with a Shard of Light."); // The (English) text shown below your weapon's name.
