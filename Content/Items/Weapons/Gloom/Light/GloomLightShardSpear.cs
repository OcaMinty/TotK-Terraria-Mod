...
{
    public class GloomLightShardSpear : ModItem
    {
        public override void SetStaticDefaults()
        {
            // Tooltip.SetDefault("A Gloom Spear fused with a Shard of Light.");
        ...
        public override void SetDefaults()
        {
            ...
            Item.shoot = ModContent.ProjectileType<GloomLightShardSpearProjectile>(); // The projectile that is fired from this weapon
