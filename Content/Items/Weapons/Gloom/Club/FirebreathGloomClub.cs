...
{
    public class FirebreathGloomClub : ModItem
    {
        public override void SetStaticDefaults()
        {
            // DisplayName.SetDefault("Fire-breath Gloom Club");
            // Tooltip.SetDefault("A Gloom Club fused with a Fire-breath Lizalfos Horn."); // The (English) text shown below your weapon's name.
        ...
        public override void SetDefaults()
        {
            ...
            Item.damage = 430; // The damage your item deals.
