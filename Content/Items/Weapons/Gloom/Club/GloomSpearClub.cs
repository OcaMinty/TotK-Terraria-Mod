...
{
    public class GloomSpearClub : ModItem
    {
        public override void SetStaticDefaults()
        {
            // DisplayName.SetDefault("Gloom Spear Club");
            // Tooltip.SetDefault("A Gloom Club fused with a Gloom Spear."); // The (English) text shown below your weapon's name.
