...
{
    public class FirebreathLongStick : ModItem
    {
        public override void SetStaticDefaults()
        {
            // DisplayName.SetDefault("Fire-breath Long Stick");
            // Tooltip.SetDefault("A Long Stick fused with a Fire-breath Lizalfos horn.");
        ...
        public override void SetDefaults()
        {
            ...
            Item.shoot = ModContent.ProjectileType<FirebreathLongStickProjectile>(); // The projectile that is fired from this weapon
