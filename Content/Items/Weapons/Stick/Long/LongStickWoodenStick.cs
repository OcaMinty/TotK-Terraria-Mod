...
{
    public class LongStickWoodenStick : ModItem
    {
        public override void SetStaticDefaults()
        {
            // Tooltip.SetDefault("A Long Stick fused with a Wooden Stick.");
        ...
        public override void SetDefaults()
        {
            ...
            Item.shoot = ModContent.ProjectileType<LongStickWoodenStickProjectile>(); // The projectile that is fired from this weapon
