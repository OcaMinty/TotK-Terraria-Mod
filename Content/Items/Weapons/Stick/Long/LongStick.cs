...
{
    public class LongStick : ModItem
    {
        public override void SetStaticDefaults()
        {
            // Tooltip.SetDefault("Perfect for fusions...");
        ...
        public override void SetDefaults()
        {
            ...
            Item.shoot = ModContent.ProjectileType<LongStickProjectile>(); // The projectile that is fired from this weapon
