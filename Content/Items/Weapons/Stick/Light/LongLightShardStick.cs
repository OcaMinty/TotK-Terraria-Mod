...
{
    public class LongLightShardStick : ModItem
    {
        public override void SetStaticDefaults()
        {
            // Tooltip.SetDefault("A Long Stick fused with a Shard of Light.");
        ...
        public override void SetDefaults()
        {
            ...
            Item.shoot = ModContent.ProjectileType<LongLightShardStickProjectile>(); // The projectile that is fired from this weapon
