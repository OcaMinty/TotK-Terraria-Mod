...
{
    public class ThickLightShardStick : ModItem
    {
        public override void SetStaticDefaults()
        {
            // DisplayName.SetDefault("Thick Light Shard Stick");
            // Tooltip.SetDefault("A Thick Stick fused with a Shard of Light."); // The (English) text shown below your weapon's name.
        ...
        public override void SetDefaults()
        {
            ...
            Item.knockBack = 13; // The force of knockback of the weapon. Maximum is 20
