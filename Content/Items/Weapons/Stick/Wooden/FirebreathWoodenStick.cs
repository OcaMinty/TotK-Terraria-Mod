...
{
    public class FirebreathWoodenStick : ModItem
    {
        public override void SetStaticDefaults()
        {
            // DisplayName.SetDefault("Fire-breath Wooden Stick");
            // Tooltip.SetDefault("A Wooden Stick fused with a Fire-breath Lizalfos Horn."); // The (English) text shown below your weapon's name.
