...
{
    public class WoodenStickThickStick : ModItem
    {
        public override void SetStaticDefaults()
        {
            // DisplayName.SetDefault("Wooden Stick Thick Stick");
            // Tooltip.SetDefault("A Wooden Stick fused with a Thick Stick."); // The (English) text shown below your weapon's name.
        ...
        public override void SetDefaults()
        {
            ...
            Item.damage = 17; // The damage your item deals.
