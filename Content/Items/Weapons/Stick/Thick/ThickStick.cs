...
namespace totk.Content.Items.Weapons.Stick.Thick
{
    public class ThickStick : ModItem
    {
        ...
        {
            // DisplayName.SetDefault("Thick Stick");
        ...
        public override void SetDefaults()
        {
            ...
            Item.value = Item.buyPrice(copper: 20); // The value of the weapon in copper coins.
        ...
        public override void AddRecipes()
        {
            ...
            CreateRecipe()
               .AddIngredient(ModContent.ItemType<Zonaite>(), 4)
