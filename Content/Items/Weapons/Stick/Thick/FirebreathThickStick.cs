...
{
    public class FirebreathThickStick : ModItem
    {
        public override void SetStaticDefaults()
        {
            // DisplayName.SetDefault("Fire-breath Thick Stick");
            // Tooltip.SetDefault("A Thick Stick fused with a Fire-breath Lizalfos Horn."); // The (English) text shown below your weapon's name.
