...
{
    public class MuddleBudArrow : ModItem
    {
        public override void SetStaticDefaults()
        {
            // DisplayName.SetDefault("Muddle Bud Arrow");
            // Tooltip.SetDefault("A Wooden Arrow fused with a Muddle Bud.");
        }
        ...
        public override void SetDefaults()
        {
            ...
            Item.shoot = ModContent.ProjectileType<MuddleBudArrowProjectile>();
            Item.shootSpeed = 18f;
        ...
        public override void AddRecipes()
        {
            CreateRecipe()
                ...
                .AddIngredient(ModContent.ItemType<MuddleBud>(), 1)
                .Register();
        }
    }
}