...
{
    public class DazzleFruitArrowProjectile : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            else
            {
                ...
                if (Main.rand.NextBool())
                {
                    ...
                    dust = Dust.NewDustDirect(Projectile.position, Projectile.width, Projectile.height, DustID.JungleTorch, 0f, 0f, 100, default, 1f);
