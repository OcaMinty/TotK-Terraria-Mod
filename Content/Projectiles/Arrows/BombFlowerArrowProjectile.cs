...
namespace totk.Content.Projectiles.Arrows
{
    ...
    public class BombFlowerArrowProjectile : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (Projectile.ai[0] > 10f)
            {
                ...
                if (Projectile.velocity.Y == 0f && Projectile.velocity.X != 1f)
                {
                    Projectile.velocity.X = Projectile.velocity.X * 1f;

                    if (Projectile.velocity.X > -0.01 && Projectile.velocity.X < 1)
                    {
