...
namespace totk.Content.Projectiles.Arrows
{
    ...
    public class FireKeeseEyeballArrowProjectile : ModProjectile
    {
        public override void SetStaticDefaults()
        {
            // DisplayName.SetDefault("Fire Keese Eyeball Arrow"); // Name of the projectile. It can be appear in chat
