...
namespace totk.Content.Projectiles.Whips
{
    public class ThickStickWhipProjectile : ModProjectile
    {
        ...
        public override bool PreAI()
        {
            ...
            if (!owner.channel || ChargeTime >= 200)
            {
            ...
            Projectile.WhipSettings.RangeMultiplier += 1 / 20f;
