...
namespace totk.Content.Projectiles.Consumables
{
    ...
    public class WhiteChuchuJellyProjectile : ModProjectile
    {
        private const int DefaultWidthHeight = 15;
        private const int ExplosionWidthHeight = 300;
        ...
        public override void AI()
        {
            ...
            else
            {
                ...
                if (Main.rand.NextBool())
                {
                    ...
                    Dust.NewDustDirect(Projectile.position, Projectile.width, Projectile.height, DustID.IceTorch, 0f, 0f, 100, default, 1f);
                    dust.scale = 1f + Main.rand.Next(5) * 1f;
                    dust.noGravity = true;
        ...
        public override void Kill(int timeLeft)
        {
            ...
            for (int i = 0; i < 80; i++)
            {
                ...
                Lighting.AddLight(dust.position, (1000f), (1000f), (1000f));
            }
