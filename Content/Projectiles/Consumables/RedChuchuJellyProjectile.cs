...
namespace totk.Content.Projectiles.Consumables
{
    ...
    public class RedChuchuJellyProjectile : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            else
            {
                ...
                if (Main.rand.NextBool())
                {
                    ...
                    Dust.NewDustDirect(Projectile.position, Projectile.width, Projectile.height, DustID.Torch, 0f, 0f, 100, default, 1f);
