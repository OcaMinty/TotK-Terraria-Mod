...
namespace totk.Content.Projectiles.Consumables
{
    ...
    public class ShardofLightProjectile : ModProjectile
    {
        private const int DefaultWidthHeight = 15;
        private const int ExplosionWidthHeight = 600;
        ...
        public override void AI()
        {
            ...
            else
            {
                ...
                if (Main.rand.NextBool())
                {
                    ...
                    dust = Dust.NewDustDirect(Projectile.position, Projectile.width, Projectile.height, DustID.Clentaminator_Green , 0f, 0f, 100, default, 1f);
        ...
        public override void Kill(int timeLeft)
        {
            ...
            for (int i = 0; i < 80; i++)
            {
                Dust dust = Dust.NewDustDirect(Projectile.position, Projectile.width, Projectile.height, DustID.Clentaminator_Green, 0f, 0f, 100, default, 3f);
                dust.noGravity = true;
                dust.velocity *= 5f;
                dust = Dust.NewDustDirect(Projectile.position, Projectile.width, Projectile.height, DustID.Clentaminator_Green, 0f, 0f, 100, default, 2f);
                dust.velocity *= 3f;
            }
