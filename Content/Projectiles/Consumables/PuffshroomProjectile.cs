...
namespace totk.Content.Projectiles.Consumables
{
    ...
    public class PuffshroomProjectile : ModProjectile
    {
        ...
        public override void Kill(int timeLeft)
        {
            ...
            for (int i = 0; i < 100; i++)
            {
                Dust dust = Dust.NewDustDirect(Projectile.position, Projectile.width, Projectile.height, ModContent.DustType<Puff>(), 0f, 0f, 100, default, 2f);
