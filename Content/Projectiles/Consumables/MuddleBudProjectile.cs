...
namespace totk.Content.Projectiles.Consumables
{
    ...
    public class MuddleBudProjectile : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            else
            {
                ...
                if (Main.rand.NextBool())
                {
                    ...
                    dust = Dust.NewDustDirect(Projectile.position, Projectile.width, Projectile.height, DustID.PurpleCrystalShard, 0f, 0f, 100, default, 1f);
