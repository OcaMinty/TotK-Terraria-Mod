...
namespace totk.Content.Projectiles.Spears.Stick
{
    public class LongLightShardStickProjectile : ModProjectile
    {
        ...
        protected virtual float HoldoutRangeMin => 65f;
        protected virtual float HoldoutRangeMax => 125f;

        public override void SetStaticDefaults()
        {
            // DisplayName.SetDefault("Long Light Shard Stick");
        }
        ...
        public override bool PreAI()
        {
            ...
            if (!Main.dedServ)
            {
                ...
                if (Main.rand.NextBool(3))
                {
                    ...
                    Dust.NewDustDirect(Projectile.position, Projectile.width, Projectile.height, DustID.CursedTorch, Projectile.velocity.X * 2f, Projectile.velocity.Y * 2f, Alpha: 128, Scale: 1.2f);
                }

                if (Main.rand.NextBool(4))
                {
                    Dust.NewDustDirect(Projectile.position, Projectile.width, Projectile.height, DustID.Sand, Alpha: 128, Scale: 0.3f);
                    Dust.NewDustDirect(Projectile.position, Projectile.width, Projectile.height, DustID.CursedTorch, Alpha: 128, Scale: 0.3f);
                }
            }
