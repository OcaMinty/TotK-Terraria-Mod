...
{
    public class LongStickLongStickProjectile : ModProjectile
    {
        ...
        protected virtual float HoldoutRangeMin => 170f;
        protected virtual float HoldoutRangeMax => 250f;

        public override void SetStaticDefaults()
        {
            // DisplayName.SetDefault("Long Stick Long Stick");
        }
