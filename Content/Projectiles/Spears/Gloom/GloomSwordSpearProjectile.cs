...
{
    public class GloomSwordSpearProjectile : ModProjectile
    {
        ...
        protected virtual float HoldoutRangeMin => 180f;
        protected virtual float HoldoutRangeMax => 290f;

        public override void SetStaticDefaults()
        {
            // DisplayName.SetDefault("Gloom Sword Spear");
        }
